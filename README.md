...
[StarlingX](https://www.starlingx.io/) is a project is a virtualization manager that aims to simplify the management and orchestration of distributed edge-cloud computing devices.
