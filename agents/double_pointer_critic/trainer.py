from agents.double_pointer_critic.agent import DoublePointerCritic
from environment.custom.knapsack.env import Knapsack
import tensorflow as tf


def trainer(env: Knapsack, agent: DoublePointerCritic, opts: dict):
    ...
    for iteration in range(n_iterations):
        ...
        with tf.GradientTape() as tape:
            value_loss, state_values = agent.compute_value_loss(discounted_rewards)
