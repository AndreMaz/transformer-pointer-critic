...
from agents.double_pointer_critic.model.critic.model import CriticModel
from agents.double_pointer_critic.model.actor.model import ActorModel
...
class DoublePointerCritic(BaseAgent):
    def __init__(self, name, opts):
        super(DoublePointerCritic, self).__init__(name, opts)
        ...
        self.critic = CriticModel(
            ...
            self.critic_encoder_embedding_size,
            self.critic_encoder_embedding_time_distributed,
            self.critic_encoder_lstm_units,
            self.critic_processing_lstm_units,
            self.critic_processing_dense_units,
            self.critic_decoder_units,
            self.critic_decoder_activation
        )
        ...
        self.update_backpack_mask = False
        self.backpack_actor = ActorModel(
            self.SOS_CODE,
            self.num_items,
            self.update_backpack_mask,
            self.actor_learning_rate,
            self.actor_encoder_embedding_size,
            self.actor_encoder_embedding_time_distributed,
            self.actor_encoder_lstm_units,
            self.actor_attention_dense_units
        )

        self.update_item_mask = True
        self.item_actor = ActorModel(
            self.SOS_CODE,
            self.num_items,
            self.update_item_mask,
            self.actor_learning_rate,
            self.actor_encoder_embedding_size,
            self.actor_encoder_embedding_time_distributed,
            self.actor_encoder_lstm_units,
    ...
    def compute_actor_loss(self, model, masks, actions, decoder_inputs, discounted_rewards, state_values):
